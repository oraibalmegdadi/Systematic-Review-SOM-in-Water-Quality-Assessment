...
| Self organizing map (som) as cluster modelling tool of algal blooms risk in maninjau lake | Sudriani, Yuli, and Astried Sunaryani. "SELF ORGANIZING MAP (SOM) AS CLUSTER MODELLING TOOL OF ALGAL BLOOMS RISK IN MANINJAU LAKE." Editors (2017): 184. |[link](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=7wNwcIcAAAAJ&citation_for_view=7wNwcIcAAAAJ:YsMSGLbcyi4C)
